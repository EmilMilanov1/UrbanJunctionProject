...
namespace UrbanJunction.Data.Migrations
{
    ...
    [Migration("20260319093724_AddNotificationsSystem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UrbanJunction.Data.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UrbanJunction.Data.Models.PostTag", b =>
                {
                    b.Property<int>("PostId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UrbanJunction.Data.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UrbanJunction.Data.Models.Comment", b =>
                {
                    b.HasOne("UrbanJunction.Data.Models.Comment", "ParentComment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("UrbanJunction.Data.Models.Notification", b =>
                {
                    ...
                    b.HasOne("UrbanJunction.Data.Models.ContactMessage", "ContactMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("UrbanJunction.Data.Models.PostTag", b =>
                {
                    ...
                    b.HasOne("UrbanJunction.Data.Models.Tag", "Tag")
                        .WithMany("PostTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
